...
using Immortal_Switch.Scripts.Profile.Views.UI;
    ...
    public class ProfileView : AnimatedUIView
    {
        ...
        private void RefreshFinalStats()
        {
            foreach (var stat in finalStats)
            {
                ...
                var statValue = ModuleManager.Instance.PowerService.GetFinalStat(stat.stat);
        ...
        private void RefreshOtherStats()
        {
            ...
            for (int i = 0; i < otherStats.Count; i++)
            {
                ...
                var statValue = ModuleManager.Instance.PowerService.GetFinalStat(statType);
