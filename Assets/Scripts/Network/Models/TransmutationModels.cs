...
public class TransmutationListResponse
{
    ...
    [JsonProperty("auto_setting")] public TransmutationAutoSettingDto AutoSetting;
}
...
// ── Auto Setting ──────────────────────────────────────────────────────────────
// Xem docs/api_transmutation_auto_setting.md

[Serializable]
public class TransmutationAutoSettingDto
{
    [JsonProperty("enabled")]        public bool               Enabled;
    [JsonProperty("count")]          public int                Count;
    [JsonProperty("tier")]           public string             Tier;
    [JsonProperty("is_waiting")]     public bool               IsWaiting;
    [JsonProperty("unique_options")] public List<List<string>> UniqueOptions;
}

[Serializable]
public class TransmutationSaveSettingRequest
{
    [JsonProperty("enabled")]        public bool               Enabled;
    [JsonProperty("count")]          public int                Count;
    [JsonProperty("tier")]           public string             Tier;
...
[Serializable]
public class TransmutationSaveSettingResponse
{
    [JsonProperty("success")] public bool   Success;
    [JsonProperty("error")]   public string Error;
}
