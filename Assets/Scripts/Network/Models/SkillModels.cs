...
[Serializable]
public class SkillAutoEquipRequest
{
    [JsonProperty("hero_uid")]   public string   HeroUid;
    /// <summary>uid của các skill sở hữu, theo thứ tự ưu tiên (skill tốt nhất trước). Server tự
    /// quyết định slot và tự gỡ các skill hiện tại không còn nằm trong danh sách này.</summary>
    [JsonProperty("skill_uids")] public string[] SkillUids;
}

[Serializable]
public class SkillAutoEquipResponse
{
    [JsonProperty("updated")]  public bool                          Updated;
    [JsonProperty("equipped")] public Dictionary<string, string[]> Equipped;
}
