...
namespace Immortal_Switch.Scripts.StageSelection
{
    ...
    public class StageSelectionView : AnimatedUIView
    {
        ...
        [Header("Controller")]
        [SerializeField]
        private StageSelectionController controller;

        [Header("Header")]
        [SerializeField]
        private TMP_Text chapterNameText;
        ...
        [Header("Rewards")]
        [SerializeField]
        private StageRewardListView baseRewardListView;

        [SerializeField]
        private StageRewardListView clearRewardListView;

        [Header("Enemies")]
        [SerializeField]
        private StageEnemyListView enemyListView;

        [Header("Buttons")]
        [SerializeField]
        private Button moveStageButton;

        [SerializeField]
        private Button highestStageButton;
        ...
        private void OnBgChange(int chapterId)
        {
            var idx = (Math.Max(0, chapterId - 1)) % visuals.Count;
